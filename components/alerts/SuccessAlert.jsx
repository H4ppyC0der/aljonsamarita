  ...
  return (
    ...
    >
      <div className="relative w-fit h-fit p-20 bg-white mx-2 rounded-lg flex flex-col gap-2 justify-center">
        <div className=" absolute top-0 inset-x-0 mx-auto -mt-[60px]  p-5 bg-green-500 w-fit h-fit flex flex-col justify-center items-center rounded-full text-white text-7xl">
          <FaCheck />
        </div>
